...
public class TestKatNetwork {
  ...
  private static final KatUniMessage plainTextMessage = KatUniMessage
    .builder()
  ...
  public void newMessageBroadcast() throws InterruptedException {
    ...
    KatEventManager.callEvent(
      MessageReceiveEvent.builder().message(plainTextMessage).build()
    );
  }
  ...
  public void newMessageIncome() {
    Request request = new Request.Builder()
      ...
      .build();
    WebSocket webSocket = wsClient.newWebSocket(
      request,
