...
public class KatDatabaseManager {
  ...
  public static void init() {
    ...
    String url = KatServer.KatConfigAPI
      .<String>getConfig(KatConfigNodeConstants.KAT_CONFIG_DATABASE_URL)
      .get();
    String username = KatServer.KatConfigAPI
      .<String>getConfig(KatConfigNodeConstants.KAT_CONFIG_DATABASE_USER_NAME)
      .orElse(null);
    String password = KatServer.KatConfigAPI
      .<String>getConfig(KatConfigNodeConstants.KAT_CONFIG_DATABASE_PASSWORD)
      .orElse(null);
  ...
  public static void create(String collection, Object data) {
    KatDatabase.getInstance().connector.connection().create(collection, data);
  }
  ...
  public static void delete(String collection, Map<String, Object> index) {
    KatDatabase.getInstance().connector.connection().delete(collection, index);
  }
  ...
  public static <T, V> List<T> search(
    String collection,
    String data,
    V top,
    V bottom,
