...
public class KatExtensionManager {
  ...
  public static void init() {
    // 注册 Event
    KatServer.KatEventBusAPI.registerEvent(
      new ExtensionEvent(new KatExtensionInfo())
    );
    KatServer.KatEventBusAPI.registerEvent(
      new LoadExtensionEvent(new KatExtensionInfo())
    );
    KatServer.KatEventBusAPI.registerEvent(
      new EnableExtensionEvent(new KatExtensionInfo())
    );
    KatServer.KatEventBusAPI.registerEvent(
      new DisableExtensionEvent(new KatExtensionInfo())
    );
