...
public class KatMessageStorage {
  ...
  public static Optional<List<KatUniMessage>> searchMessage(
    String extensionID,
    String messageGroup,
    ...
    return Optional.ofNullable(
      KatServer.KatDatabaseAPI.search(
        extensionID + "_" + messageGroup,
        "message_timestamp",
        startTimeStamp,
        endTimeStamp,
        // TODO: 商议消息数限制
   ...
   * @see Optional
   */
  public static Optional<List<KatUniMessage>> getMessage(
    @NotNull KatUniMessage indexMsg
  ) {
    return Optional.ofNullable(
      KatServer.KatDatabaseAPI.read(
        indexMsg.extensionID + "_" + indexMsg.getMessageGroup(),
  ...
  public static void updateMessage(
    @NotNull KatUniMessage oldContent,
    KatUniMessage newContent
  ) {
    KatServer.KatDatabaseAPI.update(
      oldContent.extensionID + "_" + oldContent.getMessageGroup(),
      new HashMap<String, Object>() {
        {
  ...
  public static void deleteMessage(@NotNull KatUniMessage indexMsg) {
    if (indexMsg.isFullIndex()) {
      KatServer.KatDatabaseAPI.delete(
        indexMsg.extensionID + "_" + indexMsg.getMessageGroup(),
        new HashMap<String, Object>() {
          {
  ...
  public static void createMessage(@NotNull KatUniMessage indexMsg) {
    if (indexMsg.isFullIndex()) {
      KatServer.KatDatabaseAPI.create(
        indexMsg.extensionID + "_" + indexMsg.getMessageGroup(),
        indexMsg
      );
    }
